...
const updateProduct = async(req: NextApiRequest, res: NextApiResponse<Data>) => {
    ...
    try {
        ...
        // https://res.cloudinary.com/zapataezequiel/image/upload/v1658187993/p84vbp0dzocm7e5a3ij1.jpg
        ...
        console.log(error)
        await db.disconnect();
        return res.status(400).json({ message: 'Revisar la consola del sevidor' })
    }
